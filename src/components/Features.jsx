    ...
    <>
      <motion.div className="flex flex-col justify-center items-center bg-dark text-white gap-8 pt-12 p-4" initial='hidden' whileInView={'visible'} viewport={{once : true}} variants={ConVarient} id='fre'>
        ...
        <motion.div className="flex flex-wrap justify-center items-center mt-6 gap-12" variants={TopVarient}>
          ...
          <motion.div className="w-72 md:w-96 h-80 flex flex-col justify-evenly border border-gray-800 rounded-lg shadow-xl text-center p-6 m-4" variants={TopVarient}>
          ...
          <motion.div className="w-72 md:w-96 h-80 border flex flex-col justify-evenly border-gray-800 rounded-lg shadow-xl text-center m-4 p-6" variants={TopVarient}>
